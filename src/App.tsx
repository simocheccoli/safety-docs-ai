...
const AppContent = () => {
  const { dialogOpen, latestUnreadVersion, handleDialogClose, handleMarkAsRead } = useChangelogNotification();
                  ...
                  <div className="flex-1">
                    ...
                    <main className="flex-1 p-6">
                      <Routes>
                        ...
                        <Route path="/changelog/admin" element={<ChangelogAdmin />} />
